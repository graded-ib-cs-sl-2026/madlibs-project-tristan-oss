...
public class App {
    ...
    public void start() {
        ...
        } while (playAgain.equalsIgnoreCase("yes")); // Loop if the user enters "yes" equalsIgnoreCase ignores if its
    ...
    public void printInstructions() {
        System.out.println(
                "To play this game, you will need to choose one of the categories, then input the following words. Remeber, be creative!");
    }

    /** this method asks players their name */
    ...
    public void doMadlib() {
        ...
        /*
         * Joao Porto taught me about this code. I also used the website stackoverflow
        ...
        if (category.equals("Basketball")) {
            if (madLib == 1) {
                ...
                System.out.println(
                        person + " dribbled the " + noun + " down the court with precision. With just seconds left, "
                                + pronoun + " spotted a " + noun2 + " " + adverb
                                + " approaching from the sideline. Without hesitation, "
                                + pronoun + " " + verb + " past the defense and " + verb2
                                + " an incredible shot from the three-point line. "
                                + secondPerson + " leapt to their feet and screamed, 'That was the most " + adverb2
                                + " shot I've ever seen!' "
                                + "The crowd erupted, knowing this would be a game they would never forget.");

            } else if (madLib == 2) {
                System.out.println("Interesting choices! Here is your MadLib Basketball story:");
                System.out.println(person + " made a spectacular play, using a " + noun + " to pass to " + secondPerson
                        + ". With " + pronoun + " strategy, "
                        + secondPerson + " swiftly " + verb + " and took a shot, scoring with " + adverb
                        + " flair! The crowd went wild, as "
                        + pronoun2 + " cheered for the unforgettable moment. 'What a " + adverb2
            ...
            if (madLib == 1) {
                ...
                System.out.println(person + " piloted the " + noun + " through the vast expanse of space. Suddenly, "
                        + pronoun + " encountered a "
                        + noun2 + " that was " + adverb + " floating towards the ship. Without hesitation, " + pronoun
                        + " " + verb + " the controls and "
                        + verb2 + " into hyperdrive. As the ship blasted away, " + secondPerson
                        + " exclaimed, 'That was the most " + adverb2 + " escape in the history of space travel!'");

            }

            else if (madLib == 2) {
                System.out.println("Interesting choices! Here is your MadLib space adventure:");
                System.out.println(person + " discovered a new planet while " + verb + "ing in their " + noun
                        + ". Suddenly, " + pronoun + " spotted a "
                        + noun2 + " that was " + adverb + " orbiting a nearby star. " + pronoun + " quickly " + verb2
                        + " to investigate, and as "
                        + secondPerson + " joined, they both exclaimed, 'This is the most " + adverb2
                        + " discovery ever!'");
